...
public class PauseScreen implements Screen {
    ...
    public PauseScreen(final RPGame game, Party playerParty) {
        this.game = game;
        ...
        this.title = new Text(Resources.resourceMainFont, Resources.mainTitleFontSize,"PAUSA",true);
    ...
    private void generateMenu(){
        ...
        this.menuOptions.add(new Text(Resources.resourceMainFont,mFontSize, "Volver sin guardar",true));
        this.menuOptions.add(new Text(Resources.resourceMainFont,mFontSize, "Salir de juego",true));
