...
public class EntitiesBuilderDirector implements ICharacterDirector {
    ...
    public void buildKnight(CharacterBuilder builder, World world, RPGame rpGame, String playerName){
        ...
        Item lifePotion = new Item ("Pocion vida","Da 50 puntos de vida",100,1,0,0,0,0,0,0,50);
        Item shield = new Item ("Escudo","Disminuye golpe de ataques basicos",200,1,0,0,0,20,0,0,50);
        ...
        builder.setCharacterBasicInfo(this.idCharacter,this.name,characterClass.getDescription(),position,this.level,characterClass.getInitialHealthPoints(),characterClass.getInitialMagicPoints());
