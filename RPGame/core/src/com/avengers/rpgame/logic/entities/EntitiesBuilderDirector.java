...
public class EntitiesBuilderDirector implements ICharacterDirector {
    ...
    public void buildKnight(CharacterBuilder builder, World world, RPGame rpGame, String playerName, SavedFile savedFile){
        ...
        builder.setCharacterBasicInfo(this.idCharacter,this.name,characterClass.getDescription(),position,this.level,savedFile.getCharacterInfo().getHealthPoints(),savedFile.getCharacterInfo().getMagicPoints(),0);
        builder.setCharacterAttributes(savedFile.getCharacterInfo().getStrength(),savedFile.getCharacterInfo().getSpeed(),savedFile.getCharacterInfo().getMagic(),savedFile.getCharacterInfo().getResistance(),savedFile.getCharacterInfo().getLuck());
        builder.setCharacterClass(this.characterClass);
        builder.setItems(items);
        builder.setAttacks(attacks);
        builder.setSkills(skills);
    ...
    public void buildArcher(CharacterBuilder builder, World world, RPGame rpGame, String playerName, SavedFile savedFile){
